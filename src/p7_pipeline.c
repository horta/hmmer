...
int
p7_PipelineHorta(P7_PIPELINE *pli, const P7_PROFILE *gm, P7_OPROFILE *om, P7_GMX *gx,
    P7_BG *bg, const ESL_SQ *sq, const ESL_SQ *ntsq, P7_TOPHITS *hitlist, const P7_SCOREDATA *data)
{
  P7_HIT          *hit     = NULL;     /* ptr to the current hit output data      */
  float            usc, vfsc, fwdsc;   /* filter scores                           */
  float            filtersc;           /* HMM null filter score                   */
  ...
  /*   { */
  p7_ViterbiFilter(sq->dsq, sq->n, om, pli->oxf, &vfsc);  
  /* printf("p7_ViterbiFilter: %f\n", vfsc); */
  float vfsc2;
  p7_GViterbi(sq->dsq, gm->L, gm, gx, &vfsc2);
  /* printf("p7_ViterbiFilter: %f\n", vfsc); */
