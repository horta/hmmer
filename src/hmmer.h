...
extern int p7_PipelineHorta         (P7_PIPELINE *pli, const P7_PROFILE *gm, P7_OPROFILE *om, P7_GMX *gx, P7_BG *bg, const ESL_SQ *sq, const ESL_SQ *ntsq, P7_TOPHITS *th, const P7_SCOREDATA *data);
